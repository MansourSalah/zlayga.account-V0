                    ...
                    <form class="md-float-material">
                        ...
                        <div class="auth-box">
                            <div class="row m-b-20">
                                <div class="col-md-12">
                                    <h3 class="text-center txt-primary">{{__('recoverYourPassword')}}</h3>
                                </div>
                            </div>
                            <hr/>
                            <div class="row row-rtl">
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        <input type="email" class="form-control" name="email" placeholder="{{__('enterYourEmailAddress')}}">
                                    </div>
                                </div>
                            </div>                    
...
$("form").submit(function(event) {
    ...
    $.ajax({
        url: '/api/user/forgot-password/sendMail',
        method:"POST",
        data:fd,
